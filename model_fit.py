...
"""
使用三阶多项式生成训练和测试数据的标签
y = 5 + 1.2x - 3.4x^2/2! + 5.6x^3/3! + e,where e~N(0,0.01)
"""
...
def train(train_features, test_features, train_labels, test_labels,
    ...
    for epoch in range(num_epochs):
        ...
        if epoch == 0 or (epoch + 1) % 20 == 0:
            animator.add(epoch + 1, (evaluate_loss(net, 
            train_iter, loss), evaluate_loss(net, test_iter, loss)))
